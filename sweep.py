...
# EDIT MAIN.PY
        ...
        f = open('README.md', "w+")
        f.write(
            "# {}\n## Description\n This project is part of {}:\n## Project tasks :wrench:\n\n### [{}](./{}) \n* {}\n".format(project_title, readme_repo_name, question_title_array[0], readme_file_name_array[0], question_description_array[0]))
        f = open('README.md', "a")
        f.write(
            "### [{}](./{}) \n* {}\n".format(question_title_array[1], readme_file_name_array[1], question_description_array[1]).format(i))
        f = open('README.md', "a")
        f.write(
            "### [{}](./{}) \n* {}\n".format(question_title_array[2], readme_file_name_array[2], question_description_array[2]).format(i))
        f = open('README.md', "a")
        f.write(
            "### [{}](./{}) \n* {}\n".format(question_title_array[3], readme_file_name_array[3], question_description_array[3]).format(i))
        f = open('README.md', "a")
        f.write(
            "### [{}](./{}) \n* {}\n".format(question_title_array[4], readme_file_name_array[4], question_description_array[4]).format(i))
        f = open('README.md', "a")
        try:
            f.write(
                "### [{}](./{}) \n* {}\n".format(question_title_array[55], readme_file_name_array[55], question_description_array[55]).format(i))
        except IndexError:
            pass
        ...
        print(question_description_array)
        print(question_title_array[0])
        print(readme_file_name_array[0])
        print(question_description_array[0])
